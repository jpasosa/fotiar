...
//        $this->setValidator('firstname', new sfValidatorApplyFirstname() );
        $this->setValidator('firstname', new sfValidatorString( array('required' => false, 'max_length' => 30)));
        
//        $this->setValidator('lastname', new sfValidatorApplyLastname() );
        $this->setValidator('lastname', new sfValidatorString( array('required' => false, 'max_length' => 70)));
        ...
        $this->setValidator('birthdate', new sfValidatorDateTime(array('required' => false)));
    ...
    public function doSave($con = null)
    {
        ...
        $user->setUsername($this->getValue('email'));
