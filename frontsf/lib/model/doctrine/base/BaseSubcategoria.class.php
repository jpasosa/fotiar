 ...
 * @method Subcategoria        setDescripcion()  Sets the current record's "descripcion" value
 * @method Subcategoria        setCreatedAt()    Sets the current record's "created_at" value
 * @method Subcategoria        setCreatedBy()    Sets the current record's "created_by" value
 * @method Subcategoria        setUpdatedAt()    Sets the current record's "updated_at" value
 * @method Subcategoria        setUpdatedBy()    Sets the current record's "updated_by" value
 * @method Subcategoria        setDeletedAt()    Sets the current record's "deleted_at" value
 * @method Subcategoria        setDeletedBy()    Sets the current record's "deleted_by" value
 * @method Subcategoria        setCategoria()    Sets the current record's "Categoria" value
 * @method Subcategoria        setFotografias()  Sets the current record's "Fotografias" collection
 * @method Subcategoria        setEventos()      Sets the current record's "Eventos" collection
 * 
 * @package    Fotiar
 * @subpackage model
