...
<div class="left-col">
  <div class="col-content">
    ...
    <form method="POST" action="<?=url_for('@busqueda')?>" name="busqueda">
      <div class="modulito">
        <div class="top"></div>
        <div class="content">
          <h3><?=__('Búsqueda por Categoría')?></h3>
          <div><?=$search_form['categoria_id']?></div>
          <div id="cbo-subcategoria"><?=$search_form['subcategoria_id']?></div>
        </div>
...
<div class="right-col">
  ...
  <div class="col-footer">
    <div class="pager">
      ...
      <? if($pager->haveToPaginate()): ?>
        <?
          $url_busqueda_pre = '@busqueda?page=';
          $url_busqueda_post = '';
  ...
  <? else: ?>
    <?=__('No se han encontrado fotos que coincidan con la búsqueda que realizaste.')?>
  <? endif; ?>
